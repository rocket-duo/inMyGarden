...
<%@ include file="../inc_cs.jsp" %>
	<div id="d_reviewDeatil"><h2>후기 게시판</h2>
	<hr />
	...
	<table height="400" id="t_reviewDetailContent">
	<tr>
		...
		<tr height="400" valign="top">
			<td><textarea id="reviewDeatilContent"></textarea>
			</td>
		</tr>
	</table>
	<table id="reviewDetailFile">
		<tr>
			<th>첨부파일</th>
			<td>&nbsp;&nbsp;
				<input type="text" style="height:25px;" />
				<input type="file" style="width:75px;" />
				<input type="button" value="+ 추가" class="reviewDeatilBtn" />
			</td>
		</tr>
	</table>
	<hr />
	<table >
		<tr>
			<td align="right">
			<input type="submit" value="수정" class="reviewDeatilBtn" />
			<input type="button" value="삭제" class="reviewDeatilBtn" />
			<input type="button" value="목록" class="reviewDeatilBtn" />
			</td>
		</tr>
	</table>
	</form>
