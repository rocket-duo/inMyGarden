...
<%@ include file="../inc_cs.jsp" %>
	...
	<hr />
		<form name="review_frm" action="" method="post">
			...
			<table height="400" id="t_qnaFormContent">
			<tr>
			...
			<!-- 본문 내용 작성 및 글꼴 등 디자인 항목(추후 선생님 파일 참고) -->
				...
				<tr height="400" valign="top">
					<td><textarea id="qnaFormContent"></textarea>
					</td>
				</tr>
			</table>
			<table id="qnaFormFile">
				<tr>
					<th>첨부파일</th>
					<td>&nbsp;&nbsp;
						<input type="text" style="height:25px;" />
						<input type="file" style="width:75px;" />
						<input type="button" value="+ 추가" class="qnaFormBtn" />
					</td>
				</tr>
			</table>
			<hr />
			<table>
				<tr>
					<td align="right">
					<input type="submit" value="등록" class="qnaFormBtn" />
					<input type="button" value="취소" class="qnaFormBtn" />
					</td>
				</tr>
			</table>
		</form>
