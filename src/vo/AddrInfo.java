...
public class AddrInfo {
	// 회원들의 주소록을 저장하는 클래스
	int ma_idx;
	String mi_id, ma_name, ma_phone, ma_addrname;
	String ma_zip, ma_addr1, ma_addr2, ma_basic, ma_date;
	...
	public String getMa_addrname() {
		return ma_addrname;
	}
	public void setMa_addrname(String ma_addrname) {
		this.ma_addrname = ma_addrname;
	}
